...
<div class="row justify-content-center">
    <div class="col-12 col-lg-8">
        <div class="card">
            ...
            <div class="card-body">
                <form id="Oauth2ServerPhpClientForm">
                    <div class="row justify-content-center">
                    ...
                    <div class="text-center mt-3">
                        ...
                        <button type="button" id="Cancel-Oauth2ServerPhp" class="btn btn-sm mr-3">{__('Cancel')}</button>

                        <button type="button" id="Oauth2ServerPhpClient-Save" class="btn  btn-sm ">{__('Save')}</button>
...
<script type="text/javascript">
    $('#Cancel-Oauth2ServerPhp').click(function () {
    ...
    $('#Oauth2ServerPhpClient-Save').click(function() {
        var scope = [];
        ...
        return $.ajax2({
            ...
            data: paramsSave,
            url: "{url_to('oauth2_server_php_ajax',['action'=>'SaveClient'])}",
